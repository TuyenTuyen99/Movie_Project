...
function ChangePwd() {
  ...
  const handleUpdate = (e) => {
    ...
    if (newPwd === confirmPwd) {
      api
        .put(`/user/changepwd`, sendingData)
        ...
        <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
          <form className="w-full max-w-sm" onSubmit={handleUpdate}>
            ...
            <p className="text-sm font-normal text-gray-600 mb-7 text-center">
              Please input your current password, new password and confirm
            </p>
            <label
            ...
            <label
              className="mt-4 block text-black-500 font-bold md:text-left pr-4"
              htmlFor="inline-full-name"
            >
              New Password:
            </label>
